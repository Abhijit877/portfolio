                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-8">
                                            ...
                                            <div className="flex flex-wrap gap-3">
                                                {['Hiring', 'Freelance', 'Collaboration', 'Just saying hi'].map((option) => (
                                                    <button
                                                        ...
                                                        className={`px-6 py-3 rounded-full border text-sm font-medium transition-all ${intent === option.toLowerCase()
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div className="group">
                                                ...
                                                <input
                                                    type="text"
                                                    required
                                                    className="w-full px-6 py-4 bg-background-primary/50 border border-line rounded-xl focus:ring-2 focus:ring-accent-primary/50 focus:border-accent-primary text-lg outline-none transition-all placeholder:text-white/20"
                                        ...
                                        <div className="group">
                                            ...
                                            <textarea
                                                required
                                                rows={4}
                                                className="w-full px-6 py-4 bg-background-primary/50 border border-line rounded-xl focus:ring-2 focus:ring-accent-primary/50 focus:border-accent-primary text-lg outline-none transition-all placeholder:text-white/20 resize-none"
                                        ...
                                        <Button
                                            ...
                                            icon={formState !== 'submitting' ? <FiSend /> : undefined}
                                        >
