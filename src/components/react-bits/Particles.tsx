...
const Particles: React.FC<ParticlesProps> = ({
    ...
    // Set accurate color based on theme if not overridden
    ...
    const circleParams = (): Circle => {
        ...
        const translateX = 0;
        const translateY = 0;
        const sizeVal = Math.floor(Math.random() * 2) + size;
        const alpha = 0;
    ...
    const drawCircle = (circle: Circle, update = false) => {
        if (context.current) {
            ...
            context.current.fillStyle = particleColor; // Use theme-sensitive color
